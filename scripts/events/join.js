...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("🌺🌺🌺চলে এসেছি আমি পিচ্চি 🌺★𝕊𝕂 𝕊ℍ𝔸𝕂𝕀𝕃(𝕋𝕆𝕄)𝔹𝕆𝕋★🌺 এর বট তোমাদের মাঝে🤭!আমাকে কেও welcom🥰জানাও🌺🌺🌺🌺(২)🌺🌺🌺আমাকে কন্টোল করার জন্য আমার বস কে দরকার🐱আমার বস কে দয়া করে এড দেন🐱🌺🌺🌺BOOSS.🌺ŠK ŠHÅKÎL(TØM) আর নাহয় আমাকে সামলানো রি ক্স হবে🐱🐱ধন্যবাল🌺🌺🌺Boss Fd Link :https://www.facebook.com/GOLAPI.NUNUR.ODHIKARI.TOM.YOUR.NEXT.VATAR", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
.catch(error => {
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://imgur.com/a/YeKkScE.jpeg',
          'https://imgur.com/a/W8yDBki.jpeg',
          'https://imgur.com/a/YeKkScE.jpeg',
          'https://imgur.com/a/W8yDBki.jpeg',
          'https://imgur.com/a/W8yDBki.jpeg'
        ]
