...
const nam = [{
    ...
    message: ['~ 🌺🅂🄷🄰🄺🄸🄻🌺🅃🄾🄼🌺🄱🄾🅃🌺🅃🄸🄼🄴🅁========================🐱এখন রাত ১১টা বাজে\nখাউয়া দাউয়া করে নেউ😙']
             ...
             {
    timer: '1:00:00 AM',
    message: ['~ 🌺🆂🅷🅰🅺🅸🅻🌺🆃🅾🅼🌺🅱🅾🆃🌺🆃🅸🅼🅴🆁______==========_______🐱এখন রাত ১২টা বেজে গেলো সবাই শুয়ে পড়ো🤟']
},
						{
    timer: '2:00:00 AM',
    message: ['~🌺🅂🄷🄰🄺🄸🄻🌺🅃🄾🄼🌺🄱🄾🅃🌺🅃🄸🄼🄴🅁========______=======🐱এখন রাত ১টা বাজে প্রেম না কইরা যাইয়া ঘুমা বেক্কল😾']
},
						 {
    timer: '3:00:00 AM',
    message: ['~🌺🆂🅷🅰🅺🅸🅻🌺🆃🅾🅼🌺🅱🅾🆃🌺🆃🅸🅼🅴🆁=======_______=======🐱এখন রাত ২টা বাজে যারা ছ্যাকা খাইছে তারা জেগে আছে🫠🫠।']
},
						 {
    timer: '4:00:00 AM',
    message: ['🌺🅂🄷🄰🄺🄸🄻🌺🅃🄾🄼🌺🄱🄾🅃🌺🅃🄸🄼🄴🅁_=======°======°=====🐱~এখন রাত ৩টা বাজে সবাই মনে হয় ঘুম🥹 আমার ভাই ঘুম আসে না  ']
},
						 {
    timer: '5:00:00 AM',
    message: ['~🌺🆂🅷🅰🅺🅸🅻🌺🆃🅾🅼🌺🅱🅾🆃🌺🆃🅸🅼🅴🆁=====_======_====__🐱এখন রাত ৪টা বাজে একটু পর ফজরের আযান দিলে নামাজ পড়ে নিও সবাই ']
},
						 {
    timer: '6:00:00 AM',
